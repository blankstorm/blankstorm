...
export class ServerListItem extends HTMLLIElement {
	constructor(server: ServerData) {
		...
		$(`<p class="delete" style=position:absolute;left:15%><svg><use href="assets/images/icons.svg#trash"/></svg></p>`).appendTo(this);
		$(`<p class="play" style=position:absolute;left:20%><svg><use href="assets/images/icons.svg#play"/></svg></p>`).appendTo(this);
		$(`<p class="edit" style=position:absolute;left:25%><svg><use href="assets/images/icons.svg#pencil"/></svg></p>`).appendTo(this);
