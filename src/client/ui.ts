...
import { Waypoint } from '../core/entities/waypoint.js';
import { items, type ItemID } from '../core/generic/items.js';
import type { ResearchID } from '../core/generic/research.js';
import { isResearchLocked, research } from '../core/generic/research.js';
import { genericShips } from '../core/generic/ships.js';
import { Level } from '../core/level.js';
import { config as coreConfig, currentVersion, displayVersion, game_url } from '../core/metadata.js';
import * as renderer from '../renderer/index.js';
import * as config from './config.js';
import { level, setLevel, unload } from './level.js';
...
import * as tooltip from './ui/tooltips.js';
import { switchTo } from './ui/utils.js';
import { WaypointUI } from './ui/waypoint.js';
import { account, action, player as getPlayer, hasSystem, system } from './user.js';
import { $svg, logger, minimize, upload } from './utils.js';
...
export async function init() {
	...
	$('#main .version a')
		...
		.attr('href', game_url + '/releases/' + currentVersion);
